    ...
    public function getViewHelperConfig()
    {
        return array(
            'factories' => array(
                ...
                'WdgYouTubeGallery' => function($sm) {
                    // $sm is the view helper manager, so we need to fetch the main service manager
                    $locator = $sm->getServiceLocator(); 
                    $galleryService = $locator->get("wdgyoutubegallery_service_gallery");
                    
                    return new \WdgYouTubeGallery\View\Helper\Gallery($galleryService->getAllPlaylists());
                },
            ),
        );
    }
